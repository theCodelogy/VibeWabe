        ...
        <Slider {...settings}>
          ...
          <div>
            ...
            >
              ...
              />
              <span className="absolute left-0 top-0 rounded-br-lg bg-gradient-to-r from-red-500 to-yellow-500 px-3 py-1.5 text-sm uppercase tracking-wider text-white">
                Premium
              </span>
            </a>
