    ...
    <div className="text-white container  mx-auto px-5 py-12">
      <div className="relative group">
        <Link href="#">
          ...
          <button className="absolute top-0 left-24 hidden group-hover:inline-block px-4 py-2 text-white rounded-md transition-transform transform group-hover:translate-x-2 hover:underline">
            See All
          </button>
        </Link>
      </div>
...
export default ThrillersMovies;
