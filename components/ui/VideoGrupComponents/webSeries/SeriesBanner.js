                ...
                <section>
                  <div className="relative items-center w-full px-5 py-12 mx-auto md:px-12 lg:px-16 max-w-7xl lg:py-24">
                    <div class="w-full md:w-1/2 lg:pr-32">
                      ...
                      <h3 class="mt-6 md:mt-10 text-md lg:text-xl text-center md:text-left text-gray-200 font-light tracking-wider leading-relaxed">
                        Join Thomas Razor and the Blades as they navigate
                        post-war chaos, seeking redemption and power in the
                        heart of the citys shadows. Loyalties will be tested,
                        and secrets will unfold in this gripping crime drama.
                      </h3>
