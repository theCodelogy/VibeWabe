    ...
    return (
       ...
       <div className='my-10'>
        ...
        <div className='flex gap-4 justify-center items-center '>
            ...
            <li className="py-3 w-[25%] md:w-[20%] lg:w-[13%] flex-shrink-0 text-center hover:bg-blue-500 to-zinc-500 border border-gray-300 cursor-pointer duration-[.4s] text-sm flex justify-center text-white">
      Thriler Movie
    </li>
