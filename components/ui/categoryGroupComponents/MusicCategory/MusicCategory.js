...
const MusicCategory = () => {
    ...
    useEffect(() => {
      axios
        .get(`https://vibewabe-server.vercel.app/music?sortBy=view&sort=-1&limit=20`)
        .then((res) => {
          setRomantics(res.data);
          setLoading(false);
        })
        .catch((error) => {
    ...
    return (
      <div className='container mx-auto px-5'>
            <h3 className='text-white text-xl font-bold mb-4 '>Trending Music List</h3>
