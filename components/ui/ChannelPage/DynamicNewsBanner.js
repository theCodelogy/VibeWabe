    ...
    return (
        <div className="container mx-auto px-5 mt-10 mb-20 ">
            ...
            <div className="h-full">
              ...
              src="https://www.youtube.com/embed/1vVkyQSQmTw?si=p1nDZUl-QFZuxTQ_" 
        ...
        <div className="flex flex-col text-white items-start h-[300px] justify-center ">
         <h2 className="py-1 px-2 text-white bg-red-600 text-left mb-2">Fox News</h2>
         <h2  className="text-white font-bold text-xl text-left mb-2">Migrants accused of beating NYPD cops arrested after being freed without bail</h2>
