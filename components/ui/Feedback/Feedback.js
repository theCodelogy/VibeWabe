...
const Feedback = () => {
    ...
    return (
        ...
        <div className="">
          ...
          <div className="lg:h-[900px] h-[950px]">
            <Image 
          ...
          {/* <div className="lg:h-[100vh] h-auto bg-no-repeat p-20  bg-cover bg-[url('https://i.ibb.co/xCKKbpg/132773-abstract-pink-and-purple-lines-stripes-and-shapes-background-vector-illustration-1.jpg')]">
            <div className=" bg-black bg-opacity-60 text-white pb-20">
                 <h1 className="text-center lg:text-4xl md:text-3xl text-2xl font-bold pt-20 text-white ">FEEL FREE TO <br/> FEEDBACK & CONTACT</h1>
            ...
            <div className="flex lg:flex-row flex-col justify-around items-center gap-9 lg:pt-2 pt-20">
                <div className="px-5">
                     <h1 className="lg:text-2xl text-xl font-bold mb-4">Contact With Us</h1>
                     <div className="border-b-2 w-28 border-white mb-5"></div>
                     <p className="lg:w-5/12 md:w-7/12 w-auto text-lg font-semibold text-zinc-300 py-8">We are currently avaliable to take on your precious feedback, So feel free to send us a message about anything that you want to run past us. We’d love to Feedback from you.</p>
                   <h3 className="lg:text-2xl md:text-xl text-lg font-semibold pb-2 flex gap-3"><MdOutlinePhoneForwarded /> <span className="text-zinc-400 text-lg">+01316813069</span></h3>
                     <h3 className="lg:text-2xl md:text-xl text-lg font-semibold pb-2 flex gap-3"><CgMail /><span className="text-lg text-zinc-400">dev.eva.2006@gmail.com</span></h3>
                    <h3 className="lg:text-2xl md:text-xl text-lg font-semibold flex gap-3"><FaLocationDot /><span className="text-lg text-zinc-400">Dhaka , Bangladesh</span></h3>
                </div>
                <div>
               <form>
               <h1 className="lg:text-2xl text-xl font-bold text-center">Send Me Message</h1>
               <div className="border-b-4 w-28 border-white my-5 m-auto "></div>
                <div className="flex justify-center items-center flex-col">
                   <div className="flex gap-5 lg:flex-row md:flex-row flex-col justify-center mt-6">
                        <div className="form-control">
                        <label className="">
                         <input type="text" name="user_name" placeholder="Enter Your Name" className="input lg:w-72 w-auto rounded-none" required />
                        </label>
                        </div>
                         <div className="form-control">
                       <label className="">
                        <input type="email" name="user_email" placeholder="Enter Your Email" className="input lg:w-72 w-auto rounded-none" required />
                        </label>
                         </div>
                    </div>
                   <div className="form-control">
                        <label className=" mt-9">
                         <textarea name="message" id="" cols="25" rows="3" placeholder="Something Write" className="p-5 lg:pr-80 md:pr-10"></textarea>
                         </label>
                        </div>
                   <div className=" pb-5">
                   <input type="submit" value="Send Message" className="text-white bg-gradient-to-r from-red-600 to-zinc-300  border-0 py-2 px-6 focus:outline-none hover:from-zinc-300 hover:to-red-600 font-semibold duration-300 transition rounded text-md mt-8" />
