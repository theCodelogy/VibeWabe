    ...
    return (
        <div>
            <form onSubmit={handleSubmit((data) => handle(data))} className=" px-6 pt-4 pb-6 text-sm ">
                <h1 className="text-4xl text-blue-500 pt-3 font-bold text-center mb-4">Sign Up</h1>
                ...
                <div className="text-center font-medium text-slate-900 -mt-2">
                    <p>Already have account ? Please <Link className="text-blue-500" href='/login'>Login</Link></p>
                </div>
            </form>
        </div>
    );
