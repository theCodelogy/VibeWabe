    ...
    return (
        <div>
            <form onSubmit={handleSubmit((data) => handle(data))} className=" px-6 pt-4 pb-6 text-sm ">
                <h1 className="text-4xl text-red-700 pt-3 font-bold text-center mb-4">Login</h1>
                ...
                <div className="flex flex-col gap-1 mb-3 relative">
                    ...
                    <span className="text-xl text-red-700 absolute right-3 top-10" onClick={() => setPasswordShow(!passwordShow)}>
                        {
                ...
                <p className='text-red-700 font-medium '>{err && 'Please provide valid email and password.'}</p>
                <div className=" mt-6">
                ...
                <div className="text-center font-medium text-slate-900 -mt-2">
                    <p>Do not have any account ? Please <Link className="text-red-700" href='/signup'>Sign Up</Link></p>
                </div>
            </form>
        </div>
    );
