...
import animation from ".././../assets/Animation/vibeWaveAnimation.json";
    ...
    <div className="my-5 ">
      <section>
        <div class="container max-w-xl p-6 mx-auto space-y-12 lg:px-8 lg:max-w-7xl">
          <div>
            <h2 class="md:text-4xl text-xl font-semibold  text-white  text-center sm:text-5xl">
              Our Features
            </h2>
            <p class="max-w-3xl mx-auto mt-4 text-xl text-center text-gray-300 font-semibold md:text-[15px] ">
            ...
            <div>
              <div class="mt-4 space-y-12">
                <div class="flex">
                  ...
                  <div class="ml-4">
                    <h4 class="text-lg font-medium leadi text-white ">
                ...
                <div class="flex">
                  ...
                  <div class="ml-4">
                    ...
                    <p class="  mt-2  text-white">
                      {" "}
                      Dive into a diverse selection of music, podcasts, and
                      audio content tailored to your tastes. Whether you are
                      into chart-topping hits or niche genres, Vibeweb offers an
                      audio experience that resonates with you.
                    </p>
                  </div>
                </div>
                ...
                <div class="flex">
                  ...
                  <div class="ml-4">
                    ...
                    <p class="  mt-2  text-white">
                      ccess a variety of live TV channels spanning sports, news,
                      entertainment, and more. Stay updated with real-time
                      events and enjoy your favorite programs from the comfort
                      of your screen.
                    </p>
                  </div>
                </div>
