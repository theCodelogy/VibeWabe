        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            ...
            <p className="mb-8 leading-relaxed text-xs lg:text-xl text-white">
              Dive into our Feature Video Section for the latest and greatest in
              captivating content. Explore trending videos handpicked just for
              you from inspiring documentaries to entertaining short films.
              Discover, indulge, and enjoy the best of our platforms highlights
