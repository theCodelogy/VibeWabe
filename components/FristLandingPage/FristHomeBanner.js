            ...
            <div className="relative z-10 flex flex-col justify-center items-center h-full text-center">
              <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div className="text-center">
                  <p className=" mx-auto mb-4 md:text-4xl font-bold  text-white text-2xl lg:text-5xl lg:leading-tight">
                    <span className="bg-gradient-to-r from-red-500 to-yellow-500 text-transparent bg-clip-text font-extrabold">
                      Welcome{" "}
                    </span>{" "}
                    to VibeWave Website
                  </p>
                  <h1 className="max-w-2xl mx-auto px-6 lg:text-xl text-white font-inter text-xs">
                    You can join the recent trend of creating movie posters in
                    the style of Disney Pixar by showcasing your creative skills
                    through
                  </h1>
                  <div className="px-8 sm:items-start sm:justify-center sm:px-0 sm:space-x-5 sm:flex mt-9">
                    <Link
                      href={"/signup"}
                      className="mb-3 sm:mb-0 inline-flex items-center justify-center w-full px-8 py-3 text-lg font-bold text-white transition-all duration-200 bg-gradient-to-r from-red-600 to-orange-500  hover:bg-gradient-to-b  hover:shadow-2xl hover:shadow-orange-400 hover:-translate-y-px border-transparent sm:w-auto rounded-xl border-0 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900"
                    >
                      Get Started
                    </Link>
                  </div>
